...
<html>
    ...
    <body>
        ...
        <div id="show-usuarioPermissao" class="content scaffold-show" role="main">
            ...
            <f:display bean="usuarioPermissao" />
            <g:form resource="${this.usuarioPermissao}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.usuarioPermissao}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
